...
//! ## Architecture
//!
//! 1. **Collection pass** — registers all top-level types, traits, and function signatures into the
//!    [`TypeRegistry`].
//! 2. **Checking pass** — visits every function body, infers types, and validates constraints. Type
//!    inference uses unification (see [`InferCtx`]).
//!
//! ## Sub-modules
//!
